...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    inputWidth.onchange = () => {
        isWidthError = checkInput(inputWidth, widthError);
        isButtonDisabled();
    };
    ...
    inputHeight.onchange = () => {
        isHeightError = checkInput(inputHeight, heightError);
        isButtonDisabled();
    };
...
function renderField() {
    ...
    for(let i = 0; i < HEIGHT; i++) {
        console.log(valueArray[i * WIDTH].value, valueArray[i * WIDTH + 1].value, valueArray[i * WIDTH + 2].value,
            valueArray[i * WIDTH + 3].value, valueArray[i * WIDTH + 4].value, valueArray[i * WIDTH + 5].value,
            valueArray[i * WIDTH + 6].value, valueArray[i * WIDTH + 7].value, valueArray[i * WIDTH + 8].value,
            valueArray[i * WIDTH + 9].value)
    }
